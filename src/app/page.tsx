...
export default function Home() {
  ...
  function onChange(e: any) {
    ...
    setCurrent([current[0], { ...current[1], [e.target.name]: e.target.value }, current[2]])
  }
      ...
      <div className="w-1/2 h-full bg-white rounded-md font-serif overflow-auto">
        <div className="w-full flex flex-col justify-start items-start ">
          <div className="flex flex-col justify-center items-center py-6 w-full bg-slate-800">
            <p className="font-bold text-2xl text-white">Yash Chauhan</p>
              ...
              <div className="flex gap-6 w-full">
                <div className="flex flex-col gap-1 ">
                  ...
                  <DatePicker
                    ...
                    setDate={(date: any) => setCurrent([current[0], { ...current[1], start: date }, current[2]])}
                  />
                </div>
                <div className="flex flex-col gap-1 ">
                  ...
                  <DatePicker
                    date={current[1]?.end}
                    setDate={(date: any) => setCurrent([current[0], { ...current[1], end: date }, current[2]])}
                  />
                </div>
              </div>
              <div className="flex flex-col gap-1 w-full">
                ...
                <EditorComponent
                  ...
                  setValue={(value: any) => setCurrent([current[0], { ...current[1], description: value }, current[2]])}
                />
              </div>
